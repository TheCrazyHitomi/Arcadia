...
// Typage du composant LogoVar1
const NewsletterIcon: React.FC = () => {
    return (
        <div style={{width:"48px", height:"48px", display:"flex", justifyContent:"center", alignItems:"center"}}>
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-envelope-paper-heart" viewBox="0 0 16 16">
